defmodule AgriRelay.Infrastructure.HarvestJob do
  require Logger
  @moduledoc "Infrastructure adapter for harvest job."
  def execute(cooperative_id, payload) when cooperative_id not in [nil, ""] and is_map(payload) do
    Logger.info("harvest-job dispatched", cooperative_id: cooperative_id)

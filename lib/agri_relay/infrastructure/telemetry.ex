defmodule AgriRelay.Infrastructure.Telemetry do
  require Logger
  @moduledoc "Infrastructure adapter for telemetry."
  def execute(cooperative_id, payload) when cooperative_id not in [nil, ""] and is_map(payload) do
    Logger.info("telemetry dispatched", cooperative_id: cooperative_id)

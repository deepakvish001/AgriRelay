defmodule AgriRelay.Infrastructure.RedisIdempotency do
  require Logger
  @moduledoc "Infrastructure adapter for redis idempotency."
  def execute(cooperative_id, payload) when cooperative_id not in [nil, ""] and is_map(payload) do
    Logger.info("redis-idempotency dispatched", cooperative_id: cooperative_id)
